...
const std::vector<Emotion>& builtins() {
  static const std::vector<Emotion> v = {
      //name          eye {w,h,open,lift,brow}   blink  r    g    b     mood       registro
